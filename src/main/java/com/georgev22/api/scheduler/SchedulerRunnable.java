...
import com.georgev22.api.scheduler.interfaces.Scheduler;
...
public abstract class SchedulerRunnable implements Runnable {
     ...
     * @see Scheduler#runTask(Class, Runnable)
     */
    @NotNull
     ...
     * @throws IllegalArgumentException if clazz, is null
     * @throws IllegalStateException    if this was already scheduled
     * @see Scheduler#runTaskAsynchronously(Class, Runnable)
     */
    @NotNull
     ...
     * @throws IllegalArgumentException if clazz, is null
     * @throws IllegalStateException    if this was already scheduled
     * @see Scheduler#runTaskLater(Class, Runnable, long)
     */
    @NotNull
     ...
     * @throws IllegalArgumentException if clazz, is null
     * @throws IllegalStateException    if this was already scheduled
     * @see Scheduler#runTaskLaterAsynchronously(Class, Runnable, long)
     */
    @NotNull
     ...
     * @throws IllegalArgumentException if clazz, is null
     * @throws IllegalStateException    if this was already scheduled
     * @see Scheduler#runTaskTimer(Class, Runnable, long, long)
     */
    @NotNull
