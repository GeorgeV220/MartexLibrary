...
class Task implements com.georgev22.api.scheduler.interfaces.Task, Runnable {
    ...
    private final Consumer<com.georgev22.api.scheduler.interfaces.Task> cTask;
    private final Class<?> clazz;
    private final int id;
    private final long createdAt = System.nanoTime();

    Task() {
        this(null, null, com.georgev22.api.scheduler.Task.NO_REPEATING, com.georgev22.api.scheduler.Task.NO_REPEATING);
    }

    Task(final Object task) {
        this(null, task, com.georgev22.api.scheduler.Task.NO_REPEATING, com.georgev22.api.scheduler.Task.NO_REPEATING);
    }
    ...
    Task(final Class<?> clazz, final Object task, final int id, final long period) {
        ...
        if (task instanceof Runnable) {
            ...
            this.cTask = (Consumer<com.georgev22.api.scheduler.interfaces.Task>) task;
            this.rTask = null;
        } else if (task == null) {
            // Head or Future task
            this.rTask = null;
    ...
    public boolean isCancelled() {
        return (period == com.georgev22.api.scheduler.Task.CANCEL);
    }
     ...
     */
    boolean cancel0() {
        setPeriod(com.georgev22.api.scheduler.Task.CANCEL);
        return true;
    }
}
